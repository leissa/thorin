...
template<FOp  > const Def* normalize_FOp  (const Def*, const Def*, const Def*, const Def*);
template<ICmp > const Def* normalize_ICmp (const Def*, const Def*, const Def*, const Def*);
template<FCmp > const Def* normalize_FCmp (const Def*, const Def*, const Def*, const Def*);
